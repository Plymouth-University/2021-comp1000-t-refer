...
namespace Tests
{
    public class Tests
    {
        ...
        public void TestPlayerActions()
        {
            ...
            crawler.ProcessUserInput("L");
            Assert.True(crawler.GetPlayerAction() == (int)Game.PlayerActions.EAST, "Game is Active and player triggered moving using <L> but not the correct action was triggered");
            crawler.ProcessUserInput("I");
            Assert.True(crawler.GetPlayerAction() == (int)Game.PlayerActions.NORTH, "Game is Active and player triggered moving using <I> but not the correct action was triggered");
            crawler.ProcessUserInput("J");
            Assert.True(crawler.GetPlayerAction() == (int)Game.PlayerActions.WEST, "Game is Active and player triggered moving using <J> but not the correct action was triggered");
            crawler.ProcessUserInput("E");
            Assert.True(crawler.GetPlayerAction() == (int)Game.PlayerActions.PICKUP, "Game is Active and player triggered pickup using <E> but not the correct action was triggered");
            crawler.ProcessUserInput("K");
            Assert.True(crawler.GetPlayerAction() == (int)Game.PlayerActions.SOUTH, "Game is Active and player triggered moving using <K> but not the correct action was triggered");
            crawler.ProcessUserInput("start");
